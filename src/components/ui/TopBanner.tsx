...
export const TopBanner: React.FC = () => {
  ...
  return (
    <div className="relative z-40 bg-gradient-to-r from-black via-[#FF007A]/90 to-black text-white text-[11px] sm:text-xs font-semibold py-2 px-4 shadow-md border-b border-[#FF007A]/30 overflow-hidden select-none">
