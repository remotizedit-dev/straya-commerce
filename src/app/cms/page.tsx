      ...
      {editingCOA && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
          <form
            ...
            className="bg-white border border-slate-300 rounded-3xl p-6 sm:p-8 max-w-lg w-full text-slate-900 space-y-4 shadow-2xl"
          >
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <h3 className="text-lg font-bold uppercase text-slate-900">Edit COA Report</h3>
              <button type="button" onClick={() => setEditingCOA(null)} className="p-2 text-slate-400 hover:text-black cursor-pointer">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="sm:col-span-2">
                <label className="block text-slate-700 font-bold mb-1">Report Image URL *</label>
                <input
                  type="text"
                  required
                  value={editingCOA.imageUrl}
                  onChange={(e) => setEditingCOA({ ...editingCOA, imageUrl: e.target.value })}
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2.5 text-slate-900 font-mono"
                />
              </div>
              <div className="sm:col-span-2">
            ...
            <div className="flex justify-end space-x-3 pt-3 border-t border-slate-200">
              <button type="button" onClick={() => setEditingCOA(null)} className="px-4 py-2.5 bg-slate-100 text-slate-700 text-xs rounded-xl font-bold border border-slate-300">
                Cancel
              </button>
              <button type="submit" className="bg-slate-900 hover:bg-black text-white text-xs px-6 py-2.5 rounded-xl font-bold cursor-pointer shadow-md">
                Update COA Document
              </button>
            </div>
          </form>
